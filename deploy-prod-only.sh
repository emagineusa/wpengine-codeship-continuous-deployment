# This is a deployment script for use during active development where only one
# WP Engine environment is in use and it doesn't make sense to add staging or dev. 
